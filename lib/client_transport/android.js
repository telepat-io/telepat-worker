 ...
 */
AndroidTransportWorker.prototype.sendNotification = function(applicationId, notification, pnTokens, callback) {
	...
	gcmConnections[applicationId].send(notification, {registrationTokens: pnTokens}, callback);
};

/**
 *
 * @param {Object} message
 * @param {object} message.payload An object that has the Subscription as the key and the deltas its value
 */
